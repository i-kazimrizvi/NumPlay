...
public class MainActivity extends AppCompatActivity implements View.OnClickListener,View.OnTouchListener {
    ...
    private Button clearBtn, classBtn,visible;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        visible.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                touchDrawView.setVisibility(View.INVISIBLE);
            }
        });


        touchDrawView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        touchDrawView.setBGColor(getColor(android.R.color.holo_orange_light));
        touchDrawView.setStrokeWidth(30f);
        ...
        touchDrawView.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (action == MotionEvent.ACTION_DOWN) {
                    ...
                    return false;
                    //if finger is lifcompile 'com.google.android.gms:play-services:4.2.42'ted, stop drawing
